...
import cn.hzxiaojietan.base.event.LoginTokenInvalidEvent;
...
//        }
    ...
    public void onFail(String message) {
        if (message != null) {
            ToastUtils.show(BaseApplication.getContext(),message);
        } else {
            ToastUtils.show(BaseApplication.getContext(), ERROR_MSG);
        }
    }
}
