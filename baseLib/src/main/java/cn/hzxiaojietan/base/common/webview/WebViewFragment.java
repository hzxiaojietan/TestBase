package cn.hzxiaojietan.base.common.webview;
...
import cn.hzxiaojietan.base.R2;
...
public class WebViewFragment extends BaseFragment {
    ...
    @OnClick({R2.id.img_title_left})
    public void onClick(View view) {
        switch (view.getId()) {
            case R2.id.img_title_left:
                //返回
                onBackPressed();
                break;
        }
    ...
    public class JavaScriptInterface {
        ...
        public String getUserData() {
            ...
            userData.userId = DialogUtils.getCurrentUser().getUserId();
            userData.token = DialogUtils.getToken();
