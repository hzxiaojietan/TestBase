...
import cn.hzxiaojietan.base.common.baseui.refreshview.IListDataView;
import cn.hzxiaojietan.base.common.baseui.refreshview.IRefreshRecyclerView;
import cn.hzxiaojietan.base.common.baseui.refreshview.SwipeRefreshRecyclerView;
...
public class BaseRecyclerFragment<T extends IBasePresenter> extends BaseFragment<T> implements IListDataView {
    ...
    protected View createRootView(LayoutInflater inflater, ViewGroup container){
        return inflater.inflate(cn.hzxiaojietan.base.R.layout.fragment_base_list, container, false);
    }
