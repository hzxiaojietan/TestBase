package cn.hzxiaojietan.base.common.baseui.refreshview;
...
import cn.hzxiaojietan.base.common.utils.ScreenUtils;
...
public class EmptyView implements IEmptyView {
    ...
    private void init() {
        mViewEmpty = mInflater.inflate(cn.hzxiaojietan.base.R.layout.view_empty, null);
        mImgEmpty = (ImageView) mViewEmpty.findViewById(cn.hzxiaojietan.base.R.id.img_empty);
        mTvEmpty = (TextView) mViewEmpty.findViewById(cn.hzxiaojietan.base.R.id.tv_empty);
        mBtnEmpty = (TextView) mViewEmpty.findViewById(cn.hzxiaojietan.base.R.id.btn_empty);

        mViewError = mInflater.inflate(cn.hzxiaojietan.base.R.layout.view_error, null);
        mImgError = (ImageView) mViewError.findViewById(cn.hzxiaojietan.base.R.id.img_error);
        mTvError = (TextView) mViewError.findViewById(cn.hzxiaojietan.base.R.id.tv_error);
        mLayoutError = mViewError.findViewById(cn.hzxiaojietan.base.R.id.layout_error);

        mViewLoading = mInflater.inflate(cn.hzxiaojietan.base.R.layout.view_loading, null);
        mTvLoading = (TextView) mViewLoading.findViewById(cn.hzxiaojietan.base.R.id.tv_loading);
        mProgressBar = (ProgressBar) mViewLoading.findViewById(cn.hzxiaojietan.base.R.id.pb_loading);
        ...
        //TODO:设置通用加载背景
        mEmptyRoot.setBackgroundResource(cn.hzxiaojietan.base.R.color.color10);
    ...
    public void showError() {
        ...
        //还原错误信息
        mTvError.setText(mContext.getString(cn.hzxiaojietan.base.R.string.place_hold_error));
    }
